...
INSERT INTO sec_role VALUES(null,now(),now(),0,'ROLE_TURISMO_ADMIN','ROLE_TURISMO_ADMIN',1,1,1);
INSERT INTO sec_role VALUES(null,now(),now(),0,'ROLE_TURISMO','ROLE_TURISMO',1,1,1);
...
VALUES ('fa42eef2-9ed7-4a1d-bc0c-6563ad0295f6','Viagens', '/viagem/list', 'e6605a3c-1b39-46af-bd64-f006628bd3c6', null, now(), now(), 1, 1, 1);
...
INSERT INTO cfg_program(uuid, descricao, url, app_uuid, entmenu_uuid ,inserted, updated, estabelecimento_id, user_inserted_id, user_updated_id)
VALUES ('cc1990f1-ca04-4dc8-82ac-5db813e04ff1','Itinerários', '/itinerario/list', 'e6605a3c-1b39-46af-bd64-f006628bd3c6', null, now(), now(), 1, 1, 1);
...
INSERT INTO cfg_program(uuid, descricao, url, app_uuid, entmenu_uuid ,inserted, updated, estabelecimento_id, user_inserted_id, user_updated_id)
VALUES ('3cd94830-69b7-48a9-86cd-a25f5d1ba160','Agências', '/agencia/list', 'e6605a3c-1b39-46af-bd64-f006628bd3c6', null, now(), now(), 1, 1, 1);
...
INSERT INTO cfg_entmenu(uuid, label, icon, tipo, program_uuid, pai_uuid, ordem, css_style, inserted, updated, estabelecimento_id, user_inserted_id, user_updated_id)
VALUES ('e83f9266-2b4c-4e24-ab4e-ea8afdd18e48', 'Agência', 'fas fa-comments-dollar', 'ENT', '3cd94830-69b7-48a9-86cd-a25f5d1ba160', '24ba2935-4d81-41aa-95c2-754cf9857f63', 1 , null, now(), now(), 1, 1, 1);
...
INSERT INTO cfg_program(uuid, descricao, url, app_uuid, entmenu_uuid ,inserted, updated, estabelecimento_id, user_inserted_id, user_updated_id)
VALUES ('086e29df-a3aa-446b-ade0-218882e23e7b','Veículos', '/veiculo/list', 'e6605a3c-1b39-46af-bd64-f006628bd3c6', null, now(), now(), 1, 1, 1);
...
INSERT INTO cfg_program(uuid, descricao, url, app_uuid, entmenu_uuid ,inserted, updated, estabelecimento_id, user_inserted_id, user_updated_id)
VALUES ('95a025f6-5732-4c2f-a212-2fcdd70c8770','Motoristas', '/motorista/list', 'e6605a3c-1b39-46af-bd64-f006628bd3c6', null, now(), now(), 1, 1, 1);
